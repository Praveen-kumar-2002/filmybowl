...
const StatusBar = () => {
  ...
  return (
    <div className="w-full relative py-4 border-b border-neutral-100 dark:border-neutral-900 bg-white dark:bg-neutral-950/20 select-none">
      
      {/* Scroll controls */}
      <button 
        onClick={() => handleScroll('left')} 
        className="absolute left-1.5 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow flex items-center justify-center text-neutral-600 dark:text-neutral-300 hover:text-red-655"
      ...
      <button 
        ...
        className="absolute right-1.5 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow flex items-center justify-center text-neutral-600 dark:text-neutral-300 hover:text-red-655"
        ...
        {celebrityStories.map((story, idx) => (
          ...
          >
            ...
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full p-[3px] bg-gradient-to-tr from-yellow-500 via-red-500 to-pink-500 hover:scale-105 duration-300 transform shadow-md relative">
              ...
              {/* Ping notification to look active */}
              {idx < 3 && (
      ...
      <AnimatePresence>
        {activeStoryIdx !== null && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-neutral-955/98 z-50 flex items-center justify-center p-4 backdrop-blur-md"
          >
            ...
            <button
              ...
              className="absolute top-4 right-4 text-white hover:text-red-500 p-2 text-2xl z-50 bg-black/40 rounded-full"
            ...
            <button
              onClick={prevStory}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-50 text-white hover:text-red-500 p-3 text-3xl bg-white/5 rounded-full hover:bg-white/10"
            ...
            <button
              onClick={nextStory}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-50 text-white hover:text-red-500 p-3 text-3xl bg-white/5 rounded-full hover:bg-white/10"
            ...
            <motion.div
              ...
              className="relative w-full max-w-sm aspect-[9/16] bg-neutral-900 rounded-2xl overflow-hidden shadow-2xl border border-white/10 z-10 flex flex-col justify-between p-4"
            >
              ...
              <div className="absolute inset-0 bg-neutral-900 z-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-black/45"></div>
              </div>
              ...
              <div className="z-10 w-full space-y-4 pt-16">
                <p className="text-white text-sm font-semibold leading-relaxed drop-shadow-md text-center">
                ...
                <div className="w-full pt-3 border-t border-white/10 flex items-center justify-center">
                  <Link
                    ...
                    onClick={closeLightbox}
                    className="inline-flex items-center gap-1.5 px-4 py-2 bg-red-650 hover:bg-red-700 text-white font-bold text-xs rounded-xl shadow-md transition-colors"
                  >
                    <FiLink />
                    <span>వీడియోలు/రివ్యూలు చూడండి</span>
                  </Link>
                </div>
              </div>
